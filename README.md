...
Using navigation graph functionality to build one activity application with bunch of fragments.
One Activity, many fragments pattern using androidx.navigation.fragment.NavHostFragment
